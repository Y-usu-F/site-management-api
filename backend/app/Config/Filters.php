...
use App\Filters\IdempotencyKeyFilter;
...
class Filters extends BaseFilters
{
    ...
    public array $aliases = [
        ...
        'auth-token'    => AuthTokenFilter::class,
        'active-user'   => ActiveUserFilter::class,
        'rate-limit'    => RateLimitFilter::class,
        'api-response-format' => ApiResponseFormatFilter::class,
        'tenant'        => TenantFilter::class,
        'request-id'    => RequestIdFilter::class,
        'request-context' => RequestContextFilter::class,
        'idempotency'   => IdempotencyKeyFilter::class,

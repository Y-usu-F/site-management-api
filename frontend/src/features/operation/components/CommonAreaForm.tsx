  ...
  return (
    <form className="space-y-4" onSubmit={(e) => {
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <input value={siteId} onChange={(e) => setSiteId(e.target.value)} placeholder={t('site', { ns: 'operations' })} className="rounded border px-3 py-2 text-sm" />
        ...
        <input value={code} onChange={(e) => setCode(e.target.value)} placeholder={t('code', { ns: 'operations' })} className="rounded border px-3 py-2 text-sm" />
        <input value={capacity} onChange={(e) => setCapacity(e.target.value)} placeholder={t('capacity', { ns: 'operations' })} className="rounded border px-3 py-2 text-sm" />
      </div>

  ...
  return (
    <form className="space-y-4" onSubmit={(e) => {
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <input value={siteId} onChange={(e) => setSiteId(e.target.value)} placeholder="site_id" className="rounded border px-3 py-2 text-sm" />
        ...
        <input value={capacity} onChange={(e) => setCapacity(e.target.value)} placeholder="capacity" className="rounded border px-3 py-2 text-sm" />
      </div>
